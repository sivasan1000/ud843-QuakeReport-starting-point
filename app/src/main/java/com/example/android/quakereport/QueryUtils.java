...
//        // Test #1 for the progress bar - 2 sec.
//        try {
//            Thread.sleep(2000);
...
//        }
        ...
        // Extract relevant fields from the JSON response and create an {@link Event} objects.
...
//             */
//
////            Finish implementing the TODO that was left in the QueryUtils.extractEarthquakes() method.
...
//    }
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            // Convert earthquakeJSON String into a JSONObject
            JSONObject baseJsonResponse = new JSONObject(earthquakeJSON);

            // Extract “features” JSONArray - the list of earthquakes
            JSONArray earthquakeArray = baseJsonResponse.optJSONArray("features");

            // Loop through each feature (earthquake) in the array - create an object
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                // Extract “mag” for magnitude - change String with double - see also Earthquake.java
